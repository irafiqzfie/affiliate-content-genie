      ...
      <>
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
          <button 
            ...
            title={connections.facebook ? "Facebook Connected" : "Connect Facebook"}
          >
          ...
          <button 
            ...
            title={connections.threads ? "Threads Connected" : "Connect Threads"}
          >
            <ThreadsIcon size={20} />
            {connections.threads ? (
              <>
          ...
          <div className="auth-signed-in" style={{ marginLeft: '0.5rem' }}>
